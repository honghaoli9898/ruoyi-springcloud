...
import com.sdps.module.bpm.service.task.BpmActivityService;
...
public class BpmActivityController {
    ...
    public CommonResult<List<BpmActivityRespVO>> getActivityList(
        ...
        return CommonResult.success(activityService.getActivityListByProcessInstanceId(processInstanceId));
    }
}
