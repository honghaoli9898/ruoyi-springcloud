...
import com.sdps.module.bpm.service.definition.BpmFormService;

import com.sdps.module.bpm.controller.admin.definition.vo.form.*;
...
public class BpmFormController {
    ...
    public CommonResult<Long> createForm(@Valid @RequestBody BpmFormCreateReqVO createReqVO) {
        return CommonResult.success(formService.createForm(createReqVO));
    }
    ...
    public CommonResult<BpmFormRespVO> getForm(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(BpmFormConvert.INSTANCE.convert(form));
    }
    ...
    public CommonResult<List<BpmFormSimpleRespVO>> getSimpleForms() {
        ...
        return CommonResult.success(BpmFormConvert.INSTANCE.convertList2(list));
    }
    ...
    public CommonResult<PageResult<BpmFormRespVO>> getFormPage(@Valid BpmFormPageReqVO pageVO) {
        ...
        return CommonResult.success(BpmFormConvert.INSTANCE.convertPage(pageResult));
    }
