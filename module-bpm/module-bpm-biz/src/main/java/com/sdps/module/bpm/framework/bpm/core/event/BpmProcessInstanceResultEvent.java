package com.sdps.module.bpm.framework.bpm.core.event;
...
import com.sdps.module.bpm.dal.dataobject.task.BpmProcessInstanceExtDO;
...
public class BpmProcessInstanceResultEvent extends ApplicationEvent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4065361426028377405L;
	/**
     * 流程实例的编号
     */
