package com.sdps.common.sms.core.client.impl.tencent;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import com.sdps.common.core.KeyValue;
import com.sdps.common.util.collection.ArrayUtils;
...
public class TencentSmsClient extends AbstractSmsClient {
    ...
    protected List<SmsReceiveRespDTO> doParseSmsReceiveStatus(String text) throws Throwable {
        ...
        return CollectionUtils.convertList(callback, status -> {
            ...
            data.setErrorCode(status.getErrCode());
            data.setErrorMsg(status.getDescription());
            data.setReceiveTime(status.getReceiveTime());
            data.setSuccess(SmsReceiveStatus.SUCCESS_CODE.equalsIgnoreCase(status.getStatus()));
            data.setMobile(status.getMobile());
            data.setSerialNo(status.getSerialNo());
    ...
    SmsTemplateRespDTO convertTemplateStatusDTO(DescribeTemplateListStatus templateStatus) {
        ...
        data.setId(String.valueOf(templateStatus.getTemplateId()));
        data.setContent(templateStatus.getTemplateContent());
        data.setAuditStatus(auditStatus.getStatus());
        data.setAuditReason(templateStatus.getReviewReply());
        return data;
    }
