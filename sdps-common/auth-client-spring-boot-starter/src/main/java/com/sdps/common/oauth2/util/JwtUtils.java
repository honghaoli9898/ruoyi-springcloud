...
import com.sdps.common.utils.RsaUtils;
...
public class JwtUtils {
	...
	public static RSAPublicKey getPubKeyObj() {
		...
		try (BufferedReader br = new BufferedReader(new InputStreamReader(
			...
			pubKey = pubKey.substring(PUBKEY_START.length(),
					pubKey.indexOf(PUBKEY_END));
	 ...
	 * "4ce02f54-3d1c-4461-8af1-73f0841a35df"
	 * ,"client_id":"webApp","scope":["app"]}
	 * 
	 * @param jwtToken
	 *            token值
	 * @param rsaPublicKey
	...
	public static Jwt encode(CharSequence content, KeyProperties keyProperties) {
		KeyPair keyPair = new KeyStoreKeyFactory(keyProperties.getKeyStore()
				.getLocation(), keyProperties.getKeyStore().getSecret()
				.toCharArray()).getKeyPair(keyProperties.getKeyStore()
				.getAlias());
	...
	public static String encodeStr(CharSequence content,
