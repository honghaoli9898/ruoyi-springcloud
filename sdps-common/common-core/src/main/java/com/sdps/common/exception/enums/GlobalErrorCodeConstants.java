package com.sdps.common.exception.enums;
...
public interface GlobalErrorCodeConstants {
	...
	ErrorCode LOCKED_IS_NULL = new ErrorCode(910, "DistributedLock is null");
	ErrorCode LOCKKEY_IS_NULL = new ErrorCode(911, "lockKey is null");
	ErrorCode LOCK_WAIT_TIMEOUT = new ErrorCode(912, "锁等待超时");
	ErrorCode LOCK_TYPE_ERROR = new ErrorCode(913, "requires RLock type");
	...
	static boolean isServerErrorCode(Integer code) {
		return code != null && code >= INTERNAL_SERVER_ERROR.getCode()
