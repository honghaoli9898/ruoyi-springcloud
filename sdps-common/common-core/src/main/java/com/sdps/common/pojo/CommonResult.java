...
import com.sdps.common.exception.ServerException;
...
public class CommonResult<T> implements Serializable {
	...
	private static final long serialVersionUID = -5782556446983821266L;
	/**
	 * 错误码
	 *
	...
	public static <T> CommonResult<T> of(T data, Integer code, String message) {
		CommonResult<T> result = new CommonResult<>();
		result.code = code;
		result.msg = message;
		result.data = data;
