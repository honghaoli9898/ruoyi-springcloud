package com.sdps.common.tenant.core.service;

import com.google.common.cache.CacheLoader;
import com.google.common.cache.LoadingCache;
import com.sdps.common.exception.ServiceException;
import com.sdps.common.util.cache.CacheUtils;
...
public class TenantFrameworkServiceImpl implements TenantFrameworkService {
	 ...
	 */
	private final LoadingCache<Object, List<Long>> getTenantIdsCache = CacheUtils
	 ...
	 */
	private final LoadingCache<Long, ServiceException> validTenantCache = CacheUtils
			.buildAsyncReloadingCache(Duration.ofMinutes(1L), // 过期时间 1 分钟
