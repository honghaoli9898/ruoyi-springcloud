package com.sdps.common.datasource.config;
...
import com.sdps.common.datasource.core.filter.DruidAdRemoveFilter;
...
public class DataSourceAutoConfiguration {
	...
	public FilterRegistrationBean<DruidAdRemoveFilter> druidAdRemoveFilterFilter(
		...
		DruidStatProperties.StatViewServlet config = properties
				.getStatViewServlet();
		// 提取 common.js 的配置路径
		String pattern = config.getUrlPattern() != null ? config
				.getUrlPattern() : "/druid/*";
