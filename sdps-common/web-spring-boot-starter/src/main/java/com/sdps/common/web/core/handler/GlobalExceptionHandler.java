package com.sdps.common.web.core.handler;

import static com.sdps.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.sdps.common.exception.enums.GlobalErrorCodeConstants.FORBIDDEN;
import static com.sdps.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.sdps.common.exception.enums.GlobalErrorCodeConstants.METHOD_NOT_ALLOWED;
import static com.sdps.common.exception.enums.GlobalErrorCodeConstants.NOT_FOUND;
...
import com.sdps.common.apilog.core.service.ApiErrorLog;
...
public class GlobalExceptionHandler {
	 ...
	 * @return 通用返回
	 */
	public CommonResult<?> allExceptionHandler(HttpServletRequest request,
			Throwable ex) {
...
//			return requestNotPermittedExceptionHandler(request,
...
//		}
		...
		if (ex instanceof AccessDeniedException) {
			return accessDeniedExceptionHandler(request,
...
//			HttpServletRequest req, RequestNotPermitted ex) {
//		log.warn("[requestNotPermittedExceptionHandler][url({}) 访问过于频繁]",
...
//	}
	...
	public CommonResult<?> defaultExceptionHandler(HttpServletRequest req,
			Throwable ex) {
	...
	private void initExceptionLog(ApiErrorLog errorLog,
		...
		errorLog.setExceptionRootCauseMessage(ExceptionUtil
		...
		Object traceId = request.getHeader(CommonConstant.TRACE_ID_HEADER);
		errorLog.setTraceId(traceId == null ? null : traceId.toString());
		...
		errorLog.setCreator(WebFrameworkUtils.getLoginUserId().toString());
	}
