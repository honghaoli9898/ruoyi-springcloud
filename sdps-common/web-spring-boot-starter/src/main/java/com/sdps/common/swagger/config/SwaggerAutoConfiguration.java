package com.sdps.common.swagger.config;
...
import com.sdps.common.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
@ConditionalOnProperty(prefix = "sdps.swagger", value = "enable", matchIfMissing = true)
