package com.sdps.common.web.config;
...
import com.sdps.common.web.core.filter.CacheRequestBodyFilter;
import com.sdps.common.web.core.filter.DemoFilter;
import com.sdps.common.web.core.filter.XssFilter;
import com.sdps.common.web.core.handler.GlobalExceptionHandler;
import com.sdps.common.web.core.handler.GlobalResponseBodyHandler;
...
public class WebAutoConfiguration implements WebMvcConfigurer {
	 ...
	 *            API 配置
	 */
	private void configurePathMatch(PathMatchConfigurer configurer,
			WebProperties.Api api) {
		AntPathMatcher antPathMatcher = new AntPathMatcher(".");
		configurer.addPathPrefix(
				api.getPrefix(),
				clazz -> clazz.isAnnotationPresent(RestController.class)
						&& antPathMatcher.match(api.getController(), clazz
								.getPackage().getName())); // 仅仅匹配 controller 包
	}
...
//				WebFilterOrderEnum.CORS_FILTER);
//	}
	...
	public FilterRegistrationBean<XssFilter> xssFilter(
			XssProperties properties, PathMatcher pathMatcher) {
	 ...
	 */
	@Bean
	@ConditionalOnProperty(value = "sdps.demo", havingValue = "true")
	public FilterRegistrationBean<DemoFilter> demoFilter() {
		return createFilterBean(new DemoFilter(),
				WebFilterOrderEnum.DEMO_FILTER);
	}
