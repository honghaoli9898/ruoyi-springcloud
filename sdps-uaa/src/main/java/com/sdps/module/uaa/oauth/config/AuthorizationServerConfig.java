...
import com.sdps.common.oauth2.constants.IdTokenClaimNames;
...
import com.sdps.module.uaa.oauth.service.impl.RedisClientDetailsService;
import com.sdps.module.uaa.oauth.service.impl.UserDetailServiceFactory;
import com.sdps.module.uaa.oauth.utils.OidcIdTokenBuilder;
...
public class AuthorizationServerConfig extends
		...
		return (accessToken, authentication) -> {
			...
			if (responseTypes.contains(SecurityConstants.ID_TOKEN)
				...
				if (principal instanceof AdminUserDO) {
					AdminUserDO user = (AdminUserDO) principal;
					if (responseTypes.contains(SecurityConstants.ID_TOKEN)) {
						// 生成id_token
	...
	private void setIdToken(Map<String, Object> additionalInfo,
			...
			IClientService clientService, AdminUserDO user) {
