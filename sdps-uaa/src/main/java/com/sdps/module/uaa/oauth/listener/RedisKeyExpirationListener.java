package com.sdps.module.uaa.oauth.listener;
...
@Component
@Slf4j
public class RedisKeyExpirationListener extends
	...
	public void onMessage(Message message, byte[] pattern) {
		...
		if (StrUtil.isNotEmpty(qc) && "1".equals(qc)) {
			log.debug("其他节点已经处理了该数据，次数跳过");
			return;
		}
		byte[] accessBakKey = serializeKey(SecurityConstants.ACCESS_BAK
				+ accessValue);
