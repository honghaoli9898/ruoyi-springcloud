...
import com.sdps.module.uaa.oauth.granter.*;
...
import com.sdps.module.uaa.oauth.service.impl.CustomTokenServices;
import com.sdps.module.uaa.oauth.service.impl.UserDetailServiceFactory;
import com.sdps.module.uaa.oauth.service.impl.UserDetailsByNameServiceFactoryWrapper;
	...
	protected List<TokenGranter> getAllTokenGranters(
		...
		if (authenticationManager != null) {
			...
			tokenGranters.add(new CasTicketTokenGranter(authenticationManager,
					tokenServices, clientDetailsService, requestFactory));
			//添加social模式
			tokenGranters.add(new SocialGranter(authenticationManager,
					tokenServices, clientDetailsService, requestFactory));
			tokenGranters.add(new MobileSmsGranter(authenticationManager,
					tokenServices, clientDetailsService, requestFactory));
		}
