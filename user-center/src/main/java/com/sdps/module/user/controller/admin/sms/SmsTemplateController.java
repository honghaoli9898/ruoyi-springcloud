...
import com.sdps.module.user.controller.admin.sms.vo.template.*;
...
public class SmsTemplateController {
    ...
    public CommonResult<SmsTemplateRespVO> getSmsTemplate(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(SmsTemplateConvert.INSTANCE.convert(smsTemplate));
    }
    ...
    public CommonResult<PageResult<SmsTemplateRespVO>> getSmsTemplatePage(@Valid SmsTemplatePageReqVO pageVO) {
        ...
        return CommonResult.success(SmsTemplateConvert.INSTANCE.convertPage(pageResult));
    }
