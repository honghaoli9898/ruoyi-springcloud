...
import com.sdps.module.user.controller.admin.permission.vo.permission.PermissionAssignRoleDataScopeReqVO;
import com.sdps.module.user.controller.admin.permission.vo.permission.PermissionAssignRoleMenuReqVO;
import com.sdps.module.user.controller.admin.permission.vo.permission.PermissionAssignUserRoleReqVO;
...
public class PermissionController {
	...
	public CommonResult<Boolean> assignRoleMenu(
		...
		tenantService.handleTenantMenu(menuIds -> reqVO.getMenuIds().removeIf(
				menuId -> !CollUtil.contains(menuIds, menuId)));
	...
	public CommonResult<Boolean> assignRoleDataScope(
		...
		permissionService.assignRoleDataScope(reqVO.getRoleId(),
				reqVO.getDataScope(), reqVO.getDataScopeDeptIds());
		return success(true);
	}
	...
	public CommonResult<Set<Long>> listAdminRoles(
