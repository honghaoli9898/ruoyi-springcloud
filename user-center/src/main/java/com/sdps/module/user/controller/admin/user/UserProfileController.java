...
public class UserProfileController {
    ...
    public CommonResult<UserProfileRespVO> profile() {
        ...
        // 获得用户角色
        List<RoleDO> userRoles = sysRoleService.getRolesFromCache(permissionService.getUserRoleIdListByUserId(user.getId()));
...
//        resp.setSocialUsers(UserConvert.INSTANCE.convertList03(socialUsers));
    ...
    public CommonResult<Boolean> updateUserProfile(@Valid @RequestBody UserProfileUpdateReqVO reqVO) {
        userService.updateUserProfile(WebFrameworkUtils.getLoginUserId(), reqVO);
    ...
    public CommonResult<Boolean> updateUserProfilePassword(@Valid @RequestBody UserProfileUpdatePasswordReqVO reqVO) {
        userService.updateUserPassword(WebFrameworkUtils.getLoginUserId(), reqVO);
        return CommonResult.success(true);
    }
    ...
    public CommonResult<String> updateUserAvatar(@RequestParam("avatarFile") MultipartFile file) throws Exception {
        ...
        String avatar = userService.updateUserAvatar(WebFrameworkUtils.getLoginUserId(), file.getInputStream());
